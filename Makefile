...
client: src/game_cli.cpp src/client.hpp src/Parser.o src/client.cpp src/olcPixelGameEngine/olcPixelGameEngine.h src/olcPixelGameEngine/stb_image.h src/config.h
ifeq ($(UN),Linux)
...
server: src/Parser.o src/server.o src/config.h
...
src/server.o: src/server.cpp src/config.h
